module.exports = {
    ...
    ownerOnly: false,
    usage: 'slowmode [amount_in_second] ou /slowmode [amount_in_second]',
    examples: ['slowmode 20 ou /slowmode 20','ou pour le desactivé','!slowmode 0 ou /slowmode 0'],
    description: 'Ajouter un ratelimit (slowmode) sur le salon',
    async run(client, message, args) {
        const value = args[0];
        if (isNaN(value) || !args[0]) return message.reply('Merci d\'entrer un \`NOMBRE\` pour indiquer la durée du slowmode!');
